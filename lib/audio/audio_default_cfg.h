...
#if (AUDIO_BLOCK_SAMPLES*2)>AUDIO_PINGPONG_SAMPLES
#error "AUDIO_PINGPONG_SAMPLES must hold two AUDIO_BLOCK_SAMPLES blocks"
#endif
...
#ifndef AUDIO_I2S_IO_TIMEOUT_MS
#define AUDIO_I2S_IO_TIMEOUT_MS 25
#endif

#ifndef AUDIO_I2S_READ_TIMEOUT_TICKS
#define AUDIO_I2S_READ_TIMEOUT_TICKS pdMS_TO_TICKS(AUDIO_I2S_IO_TIMEOUT_MS)
#endif

#ifndef AUDIO_I2S_WRITE_TIMEOUT_TICKS
#define AUDIO_I2S_WRITE_TIMEOUT_TICKS pdMS_TO_TICKS(AUDIO_I2S_IO_TIMEOUT_MS)
#endif
